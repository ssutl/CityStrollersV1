...
\newcommand{\titletext}{A dissertation submitted to The University of Manchester for the degree of\ \linebreak \textbf{\@course}\ \linebreak in the Faculty of Science and Engineering}

\newcommand{\submissiontext}{\textbf{Year of submission}\ \linebreak \@submitdate}

%\newcommand{\authortext}{\textbf{\@author}\ \linebreak ID \@studentid}
