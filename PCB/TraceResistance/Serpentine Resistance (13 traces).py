# This script calculates the resistance of a serpentine PCB trace with 13 traces.
import math
...
def calculateStraightSection():
    ...
    return 4 * 13  * calculateResistance(50e-3)

def calculateMiniCurvedSection():
    mini_curve_total = 0
    radius = 9.25e-3  # 12 mm 
    for i in range(13):
